...
public interface CreditLimitApi {
    ...
    ResponseEntity<Void> creditLimitDecreaseLimitPut(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody CustomerID body
);
    ...
    @RequestMapping(value = "/credit-limit/increase-limit",
        consumes = { "application/json" }, 
        method = RequestMethod.PUT)
    ResponseEntity<Void> creditLimitIncreaseLimitPut(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody CustomerID body
);
