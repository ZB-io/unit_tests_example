...
public interface CreditCardApplicationApi {
    ...
    ResponseEntity<Void> creditCardApplicationSubmitBranchPost(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody CustomerApplication body
);
    ...
    @RequestMapping(value = "/credit-card-application/submit-online",
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> creditCardApplicationSubmitOnlinePost(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody CustomerApplication body
);
