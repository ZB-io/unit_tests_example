...
public interface RewardPointsApi {
    ...
    ResponseEntity<Void> rewardPointsAddPointsPost(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody TransactionData body
);
    ...
    ResponseEntity<Void> rewardPointsRedeemPointsPut(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody RewardSelectionData body
);
